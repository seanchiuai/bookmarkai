  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="text-center">
        <span className="text-xl font-mona-bold">Bookmark AI</span>
...
function SignInForm() {
  return (
    <div className="max-w-md mx-auto text-center">
      <h1 className="text-3xl font-mona-heading mb-2">Welcome to Bookmark AI</h1>
      <p className="text-muted-foreground mb-8">Sign in to start managing your bookmarks with AI-powered search</p>
